...
function QuizCoreExecuter(questionNo,question,op1,op2,op3,op4,answer,score,totalQuestion)
{
	...
	// var $ImgOne = $('<img src="'+simPath+'images/cong_img.png"></img>').attr({class:"Congrats" });
	// 				$("#questionNumber"+questionNo).append($ImgOne);
	...
	$(".questionNumberTestDesign").text("Level "+score+"/"+totalQuestion);
