...
<?php include('breadcum.php'); ?>
  ...
  <blockquote> 
    <span class="title">Density of solid</span>
...
<p align="center"><iframe src="<?php echo 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'main.html'?>" frameborder="0" height="600" width="800" scrolling="no"></iframe></p>
