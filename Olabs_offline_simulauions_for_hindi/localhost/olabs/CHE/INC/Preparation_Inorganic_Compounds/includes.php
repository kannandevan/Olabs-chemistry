...
<script type="text/javascript" src="<?php getSimPath(); ?>js/help_pH.js"></script>
<script type="text/javascript" src="<?php getSimPath(); ?>js/help_potashAlum.js"></script>
<script type="text/javascript" src="<?php getSimPath(); ?>js/help_potassiumFerricOxalate.js"></script>
...
<script type="text/javascript" src="<?php getSimPath(); ?>js/simcontrols_mohrs.js"></script>
<script type="text/javascript" src="<?php getSimPath(); ?>js/simcontrols_potashAlum.js"></script>
<script type="text/javascript" src="<?php getSimPath(); ?>js/simcontrols_potassiumFerricOxalate.js"></script>
