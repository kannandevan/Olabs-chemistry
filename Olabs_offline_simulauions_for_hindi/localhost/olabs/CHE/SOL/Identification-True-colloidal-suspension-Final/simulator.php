...
<?php include('breadcum.php'); ?>
  ...
  <blockquote><span class="title">Identification of True solution, suspension and colloid </span>
...
function ChangeFile(type){
	...
	if(type=="animation"){
		...
		document.getElementById('simulation').src ="<?= 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'index.html'?>";
	
	}else{

		document.getElementById('simulation').src ="<?= 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'IdentificationOfSolution.html'?>";
...
Simulator</a></td>
    <td colspan="3" rowspan="2">  <iframe id="simulation" src="<?= 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'index.html'?>" frameborder="0" height="600" width="800" scrolling="no"></iframe></td>
  </tr>
  <tr>
