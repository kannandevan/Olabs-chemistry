...
<link  href="<?php getSimCss('mag.css'); ?>" rel="stylesheet" type="text/css" />
...
<script language="javascript" type="text/javascript" src="<?php getSimPath()?>js/jquery-1.12.4.js"></script>
<script language="javascript" type="text/javascript" src="<?php getSimPath()?>js/jquery-ui.js"></script>
