...
<script type="text/javascript" language="javascript" src="<?php getSimPath(); ?>js/jquery-ui-1.8.21.custom.min.js"></script>
...
<script language="javascript" type="text/javascript" src="<?php getSimPath()?>js/Preloader.min.js"></script>

<script language="javascript" type="text/javascript" src="<?php getSimPath()?>js/swiffy_Animation.js"></script>

<script type="text/javascript" language="javascript" src="<?php getSimPath(); ?>js/jquery.qtip-1.0.0-rc3.min.js"></script>
<script type="text/javascript" language="javascript" src="./js/touchconvert.js"></script>
<?php 
	$language=$_GET['elink_lan'];
	$locale = array("en-IN","hi-IN","ml-IN","mr-IN","kn-IN");
