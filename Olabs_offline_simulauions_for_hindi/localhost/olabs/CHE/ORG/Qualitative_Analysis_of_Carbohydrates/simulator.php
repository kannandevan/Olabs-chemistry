...
<?php include('breadcum.php'); ?>
  ...
  <blockquote> 
    <span class="title">Qualitative Analysis of Carbohydrates</span>
...
<p align="center"><iframe src="<?php echo 'vlab/'.$sub.'/'.$brch.'/'.$sim.'/'.'index.html'?>" frameborder="0" height="600" width="800" scrolling="no"></iframe></p>
