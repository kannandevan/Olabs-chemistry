				...
				$("#choice"+questionNo+"4").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						$("#questionNumber"+questionNo).remove();
						 //dssdsd
						 setTimeout(function(){
							QuizCoreExecuter(2,"The change in velocity over change in time is referred to as","Jerk","Displacement","Acceleration",'',"Acceleration",0,4)
			...
			$("#choice"+questionNo+"4").css({'pointer-events':'none'});
				...
				$("#choice"+questionNo+"4").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						...
						QuizCoreExecuter(4,"The area under velocity - time graph gives","rate of change of velocity with time","magnitude of displacement","speed of the object",'',"magnitude of displacement",0,4)
