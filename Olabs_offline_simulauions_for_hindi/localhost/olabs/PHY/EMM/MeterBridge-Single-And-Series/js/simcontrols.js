...
window.onload = function init(){
	...
	document.getElementById("expName").innerHTML=gt.gettext("Equivalent Resistance of Resistors(Series)");	
	...
	addintoDropDown( $('#resistors'),connectionOptions); /** Adding to drop down list */
}
...
function showParellelWire(e){
	...
	if(selectWire==true&&selectResistor==true&selectBattery==true){
...
function jockeyPosition(newValue){
	...
	if(sliderValue==balLength){
		...
		document.getElementById("needleRotate4").style.visibility='hidden';
			...
			document.getElementById("needleRotate1").style.MozTransform ='rotate(' +-sliderValue*.01+'rad)';	
			document.getElementById("needleRotate1").style.webkitTransformOrigin='100% 100%';
			document.getElementById("needleRotate1").style.webkitTransform = 'rotate(' +-sliderValue*.01 + 'rad)';
			document.getElementById("needleRotate2").style.MozTransformOrigin='10% 100%';
			document.getElementById("needleRotate2").style.MozTransform ='rotate(' +-sliderValue*.009 + 'rad)';	
			document.getElementById("needleRotate2").style.webkitTransformOrigin='100% 100%';
			document.getElementById("needleRotate2").style.webkitTransform = 'rotate(' +-sliderValue*.009+'rad)';
			...
			document.getElementById("needleRotate3").style.MozTransformOrigin='100% 100%';
			document.getElementById("needleRotate3").style.MozTransform ='rotate(' +-sliderValue*.005+'rad)';	
			document.getElementById("needleRotate3").style.webkitTransformOrigin='100% 100%';
			document.getElementById("needleRotate3").style.webkitTransform = 'rotate(' +-sliderValue*.005 + 'rad)';
			document.getElementById("needleRotate4").style.MozTransformOrigin='10% 100%';
			document.getElementById("needleRotate4").style.MozTransform ='rotate(' +-sliderValue*.003 + 'rad)';	
			document.getElementById("needleRotate4").style.webkitTransformOrigin='100% 100%';
			document.getElementById("needleRotate4").style.webkitTransform = 'rotate(' +-sliderValue*.003+'rad)';
