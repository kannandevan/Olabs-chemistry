				...
				$("#choice"+questionNo+"4").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						$("#questionNumber"+questionNo).remove();
						 //dssdsd
						 setTimeout(function(){
							QuizCoreExecuter(2,gt.gettext("2. The change in velocity over change in time is referred to as"),gt.gettext("Jerk"),gt.gettext("Displacement"),gt.gettext("Acceleration"),'',gt.gettext("Acceleration"),0,4)

						},1000)

						// $("#hide_calculations").css({"opacity": "1"})
						// $("#hide_calculations").css({"pointer-events": "auto"})
			...
			$("#choice"+questionNo+"4").css({'pointer-events':'none'});
				...
				$("#choice"+questionNo+"4").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						...
						QuizCoreExecuter(4,gt.gettext("4. The area under velocity - time graph gives"),gt.gettext("Rate of change of velocity with time"),gt.gettext("Magnitude of displacement"),gt.gettext("Speed of the object"),'',gt.gettext("Magnitude of displacement"),0,4)
			...
			$("#choice"+questionNo+"4").css({'pointer-events':'none'});
				...
				$("#choice"+questionNo+"4").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						...
						$("#Show_calculations").css({"pointer-events": "auto"})
						$("#Show_calculations").css({"opacity": "1"})
			...
			$("#choice"+questionNo+"3").css({'pointer-events':'none'});
				...
				$("#choice"+questionNo+"3").css({'background-color':'rgba(0,0,0,0)'})
					...
					setTimeout(function(){
						...
						// $("#Show_calculations").css({"pointer-events": "auto"})
						// $("#Show_calculations").css({"opacity": "1"})//dsdvdd
